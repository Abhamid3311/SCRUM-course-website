...
const Stat = () => {
    return (
        <section className='text-center mb-20 px-10'>
            <div class="grid grid-cols-2 lg:grid-cols-4">
                <div class="stat place-items-center  shadow-lg hover:shadow-2xl mr-3">
                ...
                <div class="stat place-items-center  hover:shadow-2xl shadow-lg">
                ...
                <div class="stat place-items-center py-8 hover:shadow-2xl shadow-lg">
                    <div class="stat-figure text-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-8 h-8 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <div class="stat-title">Classes</div>
                    <div class="stat-value text-green-500">2200+</div>
                    <div class="stat-desc"> 120 (34%)</div>
                </div>
